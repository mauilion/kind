...
var defaultCNIImages = []string{"calico/node:v3.5.2", "calico/cni:v3.5.2"}

const defaultCNIManifest = `# https://docs.projectcalico.org/v3.5/getting-started/kubernetes/installation/hosted/kubernetes-datastore/calico-networking/1.7/calico.yaml
